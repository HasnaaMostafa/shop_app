          ...
          body: ConditionalBuilder(
            ...
            builder: (context)=> SingleChildScrollView(
              physics: BouncingScrollPhysics(),
                child: ProductInItem(ShopCubit.get(context).productDetailsModel!,context)),
      ...
      children: [
        ...
        child: Container(
          ...
          child: CarouselSlider(
            items: model!.data!.images!.map((e) => CachedNetworkImage(imageUrl: "${e}",
        ...
        Text("Price ${model.data!.price.round()}",
          style: TextStyle(
              color: Colors.purple,
              fontSize: 18,
              fontWeight: FontWeight.bold
        ...
        Text("Old Price ${model.data!.oldPrice.round()}",
          style: TextStyle(
              color: Colors.grey,
        ...
        if(model.data!.discount!=0)
          Text("Discount  ${model.data!.discount}%",
            style: TextStyle(
                color: Colors.purple,
            ) ,),
        SizedBox(
        ...
        appButton(
            function:(){
              ShopCubit.get(context).ChangeToCart(model.data!.id!);
              } ,
            text: ShopCubit.get(context).cart[model.data!.id] == true? "Remove from cart" : "Add to cart",
        ...
        appButton(
            function:(){
              ShopCubit.get(context).changeFavourite(model.data!.id!);
            } ,
            text: ShopCubit.get(context).favourites[model.data!.id] == true? "Remove from favourites" : "Add to favourites",
            background: Colors.purple,
            size: double.infinity,
            textColor: Colors.white),
        SizedBox(
